-- Mugi Klub : réponse identique aux doublons et plafond anti-abus par adresse.
-- Remplace klub__inscrire de 20260915120100_klub_visiteur.sql ; ce fichier
-- fait foi pour son état final.
--
