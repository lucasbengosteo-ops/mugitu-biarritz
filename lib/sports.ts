...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      ...
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Beaucoup de rame, peu de vagues</h2>
    ...
    <div style="background:#F5EDE4;border-radius:var(--r-l);padding:28px;">
      <p style="margin:0 0 16px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#003850;">Ce qu’on regarde d’abord</p>
...
<section id="diagnostic" style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Ce qu’on voit le plus</p>
      <h2 style="margin:0 0 14px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Les blessures typiques du surf</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:var(--sect-ample) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Notre accompagnement</p>
    <h2 style="margin:0 0 14px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Trois moments dans la saison</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Avant la saison de houle</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Préparer l’épaule</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Bilan de mobilité et de force, programme de renforcement de la coiffe et du tronc, deux séances par semaine. C’est le moment où l’on gagne le plus.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Bilan</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Coiffe</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Tronc</span></div></div></div>
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Pendant la saison</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Encaisser les pics</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Suivi ostéopathique et kiné à la demande, ajustement du volume de sessions, entretien du renforcement même quand la houle est bonne.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Ostéopathie</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Entretien</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Gestion du volume</span></div></div></div>
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Après une blessure</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Revenir à l’eau</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Rééducation progressive puis reprise graduée&nbsp;: sessions courtes, spots calmes, planche plus volumineuse au début, jusqu’au retour au niveau habituel.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Rééducation</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Reprise graduée</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Testing</span></div></div></div>
  </div>
...
<section id="science" style="background:#003850;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:620px;">
      ...
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#fff;">Ce que montrent les données sur le surf</h2>
    </div>
...
<section id="urgence" style="max-width:1140px;margin:0 auto;padding:var(--sect-ample) clamp(20px,5vw,40px);">
  <div style="background:rgba(238,128,108,.1);border-radius:var(--r-xl);padding:clamp(26px,4vw,40px);display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:26px;align-items:start;">
    <div>
      ...
      <h2 style="margin:14px 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;color:#003850;">Quand consulter rapidement</h2>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:var(--h2-m);font-weight:700;letter-spacing:-.025em;">Surfeur à Biarritz ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Deux types de blessures, deux logiques</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Ce qu’on voit le plus</p>
      <h2 style="margin:0 0 14px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Les blessures typiques du rugby</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:var(--sect-ample) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Notre accompagnement</p>
    <h2 style="margin:0 0 14px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Sur la saison, pas seulement sur la blessure</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Présaison</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Construire la base</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Testing de force, protocole nordic hamstring et Copenhagen adduction, travail du cou et de l’épaule. C’est la période où la prévention est la plus rentable.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Testing</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Nordic hamstring</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Cou et épaule</span></div></div></div>
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">En saison</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Encaisser la densité</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Suivi kiné et ostéopathique entre les matchs, entretien de la force malgré le calendrier, gestion des petites douleurs avant qu’elles n’arrêtent le joueur.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Récupération</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Entretien de force</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Suivi hebdomadaire</span></div></div></div>
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Retour de blessure</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Décider sur des critères</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Reprise validée par des mesures de force et des tests de terrain, pas par la seule disparition de la douleur ni par l’importance du match à venir.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Critères chiffrés</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Tests de terrain</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Décision partagée</span></div></div></div>
  </div>
...
<section id="science" style="background:#003850;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:620px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Ce que dit la science</p>
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#fff;">Ce que montrent les données sur le rugby</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px;">
...
<section id="urgence" style="max-width:1140px;margin:0 auto;padding:var(--sect-ample) clamp(20px,5vw,40px);">
  <div style="background:rgba(238,128,108,.1);border-radius:var(--r-xl);padding:clamp(26px,4vw,40px);display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:26px;align-items:start;">
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:28px;height:28px;color:#EE806C;"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>
      <h2 style="margin:14px 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;color:#003850;">Quand consulter en urgence</h2>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:var(--h2-m);font-weight:700;letter-spacing:-.025em;">Joueur ou club du Pays basque ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">La charge avant la technique</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Ce qu’on voit le plus</p>
      <h2 style="margin:0 0 14px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Les blessures typiques du coureur</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:var(--sect-ample) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Notre accompagnement</p>
    <h2 style="margin:0 0 14px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Du bilan à l’objectif</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Au départ</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Le bilan du coureur</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Histoire d’entraînement, analyse de foulée en vidéo, mesures de force et de mobilité. On repart avec un diagnostic de charge plutôt qu’une liste d’étirements.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Analyse de foulée</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Testing</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Historique</span></div></div></div>
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Pendant la préparation</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Planifier la progression</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Construction de la montée en charge vers l’objectif, avec des paliers et des semaines allégées. Le renforcement s’intègre à la semaine plutôt qu’il ne s’ajoute.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Planification</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Renforcement</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Semaines allégées</span></div></div></div>
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">En cas de blessure</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Continuer à s’entraîner autrement</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">On adapte plutôt qu’on arrête&nbsp;: cross-training, travail de force, reprise en marche-course quand c’est nécessaire, retour progressif au volume.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Adaptation</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Cross-training</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Retour à la course</span></div></div></div>
  </div>
...
<section id="science" style="background:#003850;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:620px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Ce que dit la science</p>
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#fff;">Ce que montrent les données sur la course</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px;">
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:var(--h2-m);font-weight:700;letter-spacing:-.025em;">Un objectif à préparer, une douleur qui traîne ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">La répétition avant l’impact</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Ce qu’on voit le plus</p>
      <h2 style="margin:0 0 14px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Les blessures typiques du danseur</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:var(--sect-ample) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Notre accompagnement</p>
    <h2 style="margin:0 0 14px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Renforcer sans rigidifier</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Bilan</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Mesurer amplitude et force</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Mobilité de hanche et de cheville, force du mollet et des fessiers, contrôle sur un appui. On identifie les amplitudes utilisées sans contrôle musculaire.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mobilité</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Force</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Contrôle unipodal</span></div></div></div>
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Programme</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Construire la capacité</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Renforcement du mollet en amplitude complète, travail des fessiers et du tronc, pliométrie légère. Deux à trois séances courtes par semaine, compatibles avec les répétitions.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mollet</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Fessiers</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Pliométrie</span></div></div></div>
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Autour des représentations</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Accompagner les pics</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Suivi rapproché pendant les séries, thérapie manuelle, récupération, ajustement quand la douleur apparaît. Préparation mentale et suivi nutritionnel si besoin.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Récupération</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Préparation mentale</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Nutrition</span></div></div></div>
  </div>
...
<section id="science" style="background:#003850;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:620px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Ce que dit la science</p>
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#fff;">Ce que montrent les données sur la danse</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px;">
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:var(--h2-m);font-weight:700;letter-spacing:-.025em;">Danseur, professionnel ou en formation ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Un corps construit d’un seul côté</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Ce qu’on voit le plus</p>
      <h2 style="margin:0 0 14px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Les blessures typiques de la pelote</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:var(--sect-ample) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Notre accompagnement</p>
    <h2 style="margin:0 0 14px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Compenser l’asymétrie</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Bilan initial</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Mesurer les écarts</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Force et mobilité comparées des deux côtés, état de la main, testing de rotation d’épaule et de hanche. On chiffre ce qui n’est habituellement qu’une impression.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Testing bilatéral</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mobilité</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">État de la main</span></div></div></div>
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Programme d’entretien</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Renforcer le côté faible</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Travail du côté non dominant, renforcement de la coiffe et des rotateurs, mobilité thoracique et de hanche. Deux séances courtes par semaine suffisent.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Côté non dominant</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Coiffe</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mobilité</span></div></div></div>
    <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:var(--ls-label);text-transform:uppercase;font-weight:700;color:#04A49B;">Pendant la saison</p><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#003850;">Protéger la main</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Soin des mains, adaptation du volume de parties, ostéopathie et thérapie manuelle entre les échéances, gestion des douleurs avant qu’elles n’arrêtent le joueur.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Soin des mains</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Ostéopathie</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Charge</span></div></div></div>
  </div>
...
<section id="science" style="background:#003850;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:620px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Ce que dit la science</p>
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#fff;">Ce qu’on sait, et ce qu’on ne sait pas</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px;">
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:var(--h2-m);font-weight:700;letter-spacing:-.025em;">Pelotari au Pays basque ?</h2>
