...
export const METHODES: Methode[] = [
  {
    ...
    lead: `Retrouvez une motricité optimale grâce à une méthode de reprogrammation neuro-motrice, pratiquée au cabinet par des praticiens certifiés Allyane®.`,
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,60px);align-items:center;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Qu’est-ce que la Thérapie Allyane ?</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Rééduquer le signal, pas seulement le muscle</h2>
    ...
    <div style="border-radius:var(--r-l);overflow:hidden;aspect-ratio:4/3;box-shadow:0 14px 44px rgba(60,40,30,.14);"><img src="/allyane-session.png" alt="Séance de thérapie Allyane au cabinet Mugitu" style="width:100%;height:100%;object-fit:cover;" /></div>
  </div>
</section>
...
<section style="background:#003850;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:46px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Protocole en 3 séances</p>
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#fff;">Un parcours structuré, des résultats durables</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px;">
      <div style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:var(--r-l);padding:28px;">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;"><span style="font-size:28px;font-weight:800;color:#04A49B;letter-spacing:-.02em;">01</span><span style="padding:5px 12px;border-radius:var(--r-pill);background:rgba(4,164,155,.18);color:#04A49B;font-size:12px;font-weight:600;">1h</span></div>
        <h3 style="margin:0 0 12px;font-size:var(--h3-m);font-weight:700;color:#fff;">Le Bilan</h3>
      ...
      <div style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:var(--r-l);padding:28px;">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;"><span style="font-size:28px;font-weight:800;color:#04A49B;letter-spacing:-.02em;">02</span><span style="padding:5px 12px;border-radius:var(--r-pill);background:rgba(4,164,155,.18);color:#04A49B;font-size:12px;font-weight:600;">1h – 1h30</span></div>
        <h3 style="margin:0 0 12px;font-size:var(--h3-m);font-weight:700;color:#fff;">La Reprogrammation neuro-motrice</h3>
        <ul style="margin:0;padding-left:18px;display:flex;flex-direction:column;gap:8px;">
      ...
      <div style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:var(--r-l);padding:28px;">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;"><span style="font-size:28px;font-weight:800;color:#04A49B;letter-spacing:-.02em;">03</span><span style="padding:5px 12px;border-radius:var(--r-pill);background:rgba(4,164,155,.18);color:#04A49B;font-size:12px;font-weight:600;">À 1 mois</span></div>
        <h3 style="margin:0 0 12px;font-size:var(--h3-m);font-weight:700;color:#fff;">Le Bilan final</h3>
        <ul style="margin:0;padding-left:18px;display:flex;flex-direction:column;gap:8px;">
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="text-align:center;margin-bottom:40px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Pour qui ?</p>
    <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Indications thérapeutiques</h2>
  </div>
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:16px;">
    <div style="background:#fff;border-radius:var(--r-m);padding:22px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><h3 style="margin:0 0 6px;font-size:var(--h3-s);font-weight:700;color:#003850;">Genou</h3><p style="margin:0;font-size:13px;line-height:1.55;color:rgba(51,51,52,.62);">Post-LCA, prothèse, ménisque, levée des inhibitions du quadriceps.</p></div>
    <div style="background:#fff;border-radius:var(--r-m);padding:22px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><h3 style="margin:0 0 6px;font-size:var(--h3-s);font-weight:700;color:#003850;">Épaule</h3><p style="margin:0;font-size:13px;line-height:1.55;color:rgba(51,51,52,.62);">Post-chirurgie, capsulite, déficits de mobilité active.</p></div>
    <div style="background:#fff;border-radius:var(--r-m);padding:22px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><h3 style="margin:0 0 6px;font-size:var(--h3-s);font-weight:700;color:#003850;">Hanche</h3><p style="margin:0;font-size:13px;line-height:1.55;color:rgba(51,51,52,.62);">Post-prothèse, conflit fémoro-acétabulaire, boiterie persistante.</p></div>
    <div style="background:#fff;border-radius:var(--r-m);padding:22px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><h3 style="margin:0 0 6px;font-size:var(--h3-s);font-weight:700;color:#003850;">Cheville</h3><p style="margin:0;font-size:13px;line-height:1.55;color:rgba(51,51,52,.62);">Instabilité chronique, entorses récidivantes, déficits proprioceptifs.</p></div>
    <div style="background:#fff;border-radius:var(--r-m);padding:22px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><h3 style="margin:0 0 6px;font-size:var(--h3-s);font-weight:700;color:#003850;">Tronc</h3><p style="margin:0;font-size:13px;line-height:1.55;color:rgba(51,51,52,.62);">Lombalgies chroniques, raideurs post-opératoires.</p></div>
    <div style="background:#fff;border-radius:var(--r-m);padding:22px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><h3 style="margin:0 0 6px;font-size:var(--h3-s);font-weight:700;color:#003850;">Coude</h3><p style="margin:0;font-size:13px;line-height:1.55;color:rgba(51,51,52,.62);">Épicondylite, raideurs post-traumatiques, instabilités.</p></div>
    <div style="background:#fff;border-radius:var(--r-m);padding:22px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><h3 style="margin:0 0 6px;font-size:var(--h3-s);font-weight:700;color:#003850;">Main</h3><p style="margin:0;font-size:13px;line-height:1.55;color:rgba(51,51,52,.62);">Raideurs post-fracture, syndrome du canal carpien, dystonie.</p></div>
    <div style="background:#fff;border-radius:var(--r-m);padding:22px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><h3 style="margin:0 0 6px;font-size:var(--h3-s);font-weight:700;color:#003850;">Atteintes neurologiques</h3><p style="margin:0;font-size:13px;line-height:1.55;color:rgba(51,51,52,.62);">AVC, sclérose en plaques, troubles moteurs centraux.</p></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;">
    <div style="max-width:520px;margin-bottom:28px;">
      <p style="margin:0 0 6px;font-size:12px;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;font-weight:600;">Deux praticiens certifiés Allyane®</p>
      <h2 style="margin:0 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;">Prêt à retrouver votre mobilité ?</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px;">
      <div style="display:flex;align-items:center;gap:14px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:var(--r-m);padding:16px 18px;">
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,60px);align-items:center;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">La méthode</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Progresser sans charge lourde</h2>
    ...
    <div style="border-radius:var(--r-l);overflow:hidden;aspect-ratio:4/3;box-shadow:0 14px 44px rgba(60,40,30,.14);"><img src="/bfr.webp" alt="Entraînement BFR" style="width:100%;height:100%;object-fit:cover;" /></div>
  </div>
</section>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="text-align:center;margin-bottom:40px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Pour qui ?</p>
    <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Indications principales</h2>
  </div>
  <div style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;max-width:760px;margin:0 auto;">
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Post-chirurgie (LCA, prothèse…)</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Reprise après blessure</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Lutte contre l’amyotrophie</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Tendinopathies</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Renforcement à faible impact</span>
  </div>
</section>
...
<section style="max-width:1100px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;">
    <div style="max-width:560px;margin-bottom:28px;">
      <p style="margin:0 0 6px;font-size:12px;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;font-weight:600;">BFR au cabinet</p>
      <h2 style="margin:0 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;">Qui encadre le BFR ?</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:14px;">
      <a href="/equipe/jean-baptiste-colombie" style="display:flex;align-items:center;gap:13px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:var(--r-m);padding:14px 16px;text-decoration:none;transition:background .2s;" class="mg-inline-hover">
      ...
      <a href="/equipe/clement-cofourain" style="display:flex;align-items:center;gap:13px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:var(--r-m);padding:14px 16px;text-decoration:none;transition:background .2s;" class="mg-inline-hover">
      ...
      <a href="/equipe/hugo-daminato" style="display:flex;align-items:center;gap:13px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:var(--r-m);padding:14px 16px;text-decoration:none;transition:background .2s;" class="mg-inline-hover">
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,60px);align-items:center;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">La méthode</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">La course, décryptée par la science</h2>
    ...
    <div style="border-radius:var(--r-l);overflow:hidden;aspect-ratio:4/3;box-shadow:0 14px 44px rgba(60,40,30,.14);background:#012A3A;"><img src="/clinique-coureur-analyse.png" alt="La Clinique du Coureur®" style="width:100%;height:100%;object-fit:cover;" /></div>
  </div>
</section>
...
<section style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:46px;">
      ...
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Du bilan au plan de course</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:20px;">
      <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><span style="display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;border-radius:50%;background:#04A49B;color:#fff;font-size:16px;font-weight:800;margin-bottom:16px;">1</span><h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#003850;">Bilan du coureur</h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(51,51,52,.65);">Historique, objectifs et analyse de la charge d’entraînement.</p></div>
      <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><span style="display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;border-radius:50%;background:#04A49B;color:#fff;font-size:16px;font-weight:800;margin-bottom:16px;">2</span><h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#003850;">Analyse de foulée</h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(51,51,52,.65);">Captation vidéo et mesures&nbsp;: cadence, attaque, contact au sol.</p></div>
      <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><span style="display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;border-radius:50%;background:#04A49B;color:#fff;font-size:16px;font-weight:800;margin-bottom:16px;">3</span><h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#003850;">Plan de progression</h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(51,51,52,.65);">Éducatifs, renforcement et programmation personnalisée.</p></div>
    </div>
  </div>
</section>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  ...
  <div style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;max-width:760px;margin:0 auto;">
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Douleurs du coureur</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Retour à la course</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Optimisation de la foulée</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Prévention des blessures</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Choix de chaussures</span>
  </div>
</section>

<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:28px;align-items:center;">
    <div>
      <p style="margin:0 0 6px;font-size:12px;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;font-weight:600;">Praticien certifié La Clinique du Coureur®</p>
      <h2 style="margin:0 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;">Prenez rendez-vous</h2>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,60px);align-items:center;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">La méthode</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Cibler la tension à sa source</h2>
    ...
    <div style="border-radius:var(--r-l);overflow:hidden;aspect-ratio:4/3;box-shadow:0 14px 44px rgba(60,40,30,.14);"><img src="/dry-needling.jpg" alt="Dry Needling & Cupping" style="width:100%;height:100%;object-fit:cover;" /></div>
  </div>
</section>
...
<section style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:46px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Deux approches complémentaires</p>
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Puncture sèche &amp; ventouses</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:22px;">
      <div style="background:#fff;border-radius:var(--r-l);padding:clamp(26px,3.5vw,38px);box-shadow:0 4px 20px rgba(60,40,30,.06);">
        <div style="width:52px;height:52px;border-radius:var(--r-m);background:rgba(4,164,155,.12);display:flex;align-items:center;justify-content:center;margin-bottom:20px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:26px;height:26px;color:#04A49B;"><path d="m18 2 4 4"/><path d="m17 7 3-3"/><path d="M19 9 8.7 19.3c-1 1-2.5 1-3.4 0l-.6-.6c-1-1-1-2.5 0-3.4L15 5"/><path d="m9 11 4 4"/><path d="m5 19-3 3"/><path d="m14 4 6 6"/></svg></div>
        <h3 style="margin:0 0 12px;font-size:var(--h3-l);font-weight:700;color:#003850;letter-spacing:-.01em;">Dry Needling</h3>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  ...
  <div style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;max-width:760px;margin:0 auto;">
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Points trigger / contractures</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Tensions musculaires</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Tendinopathies</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Récupération</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Mobilité limitée</span>
  </div>
</section>
...
<section style="max-width:1100px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;">
    <div style="max-width:560px;margin-bottom:28px;">
      <p style="margin:0 0 6px;font-size:12px;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;font-weight:600;">Techniques manuelles</p>
      <h2 style="margin:0 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;">Qui pratique au cabinet ?</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:14px;">
      ...
      <a href="/equipe/lucas-bengoechea" style="display:flex;align-items:center;gap:13px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:var(--r-m);padding:14px 16px;text-decoration:none;transition:background .2s;" class="mg-inline-hover">
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,60px);align-items:center;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">La méthode</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Dénouer ce que le corps garde en mémoire</h2>
    ...
    <div style="border-radius:var(--r-l);overflow:hidden;aspect-ratio:4/3;box-shadow:0 14px 44px rgba(60,40,30,.14);"><img src="/emdr.webp" alt="Thérapie EMDR" style="width:100%;height:100%;object-fit:cover;" /></div>
  </div>
</section>
...
<section style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:46px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Le déroulé</p>
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Un protocole en trois phases</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:20px;">
      <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><span style="display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;border-radius:50%;background:#04A49B;color:#fff;font-size:16px;font-weight:800;margin-bottom:16px;">1</span><h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#003850;">Anamnèse</h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(51,51,52,.65);">Identification des événements et des objectifs thérapeutiques.</p></div>
      <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><span style="display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;border-radius:50%;background:#04A49B;color:#fff;font-size:16px;font-weight:800;margin-bottom:16px;">2</span><h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#003850;">Désensibilisation</h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(51,51,52,.65);">Stimulations bilatérales (mouvements oculaires) guidées.</p></div>
      <div style="background:#fff;border-radius:var(--r-l);padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);"><span style="display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;border-radius:50%;background:#04A49B;color:#fff;font-size:16px;font-weight:800;margin-bottom:16px;">3</span><h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#003850;">Ancrage</h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(51,51,52,.65);">Installation de ressources positives et consolidation.</p></div>
    </div>
  </div>
</section>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  ...
  <div style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;max-width:760px;margin:0 auto;">
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Traumatisme sportif</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Blocage post-blessure</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Gestion du stress & de l’anxiété</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Appréhension de la reprise</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Troubles du sommeil</span>
  </div>
</section>

<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <p style="margin:0 0 6px;font-size:12px;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;font-weight:600;">Sur rendez-vous</p>
    <h2 style="margin:0 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;">Prenez rendez-vous</h2>
    ...
    <a href="/equipe" style="display:inline-flex;align-items:center;gap:8px;padding:14px 30px;border-radius:var(--r-pill);background:#04A49B;color:#fff;font-size:15px;font-weight:600;text-decoration:none;">Contacter le cabinet <span>↗</span></a>
  </div>
</section>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,60px);align-items:center;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">La méthode</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Faire travailler le muscle, autrement</h2>
    ...
    <div style="border-radius:var(--r-l);overflow:hidden;aspect-ratio:4/3;box-shadow:0 14px 44px rgba(60,40,30,.14);"><img src="/electrostimulation.png" alt="Électrostimulation Compex" style="width:100%;height:100%;object-fit:cover;" /></div>
  </div>
</section>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  ...
  <div style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;max-width:760px;margin:0 auto;">
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Amyotrophie post-blessure</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Récupération musculaire</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Renforcement ciblé</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Préparation physique</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Gestion de la douleur</span>
  </div>
</section>
...
<section style="max-width:1100px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;">
    <div style="max-width:560px;margin-bottom:28px;">
      <p style="margin:0 0 6px;font-size:12px;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;font-weight:600;">Compex® au cabinet</p>
      <h2 style="margin:0 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;">Qui pratique l’électrostimulation ?</h2>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="max-width:760px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Le principe</p>
    <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Le bon produit, au bon endroit</h2>
...
<section style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:46px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Trois approches</p>
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Quel produit, pour quoi ?</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:22px;">
      <div style="background:#fff;border-radius:var(--r-l);padding:clamp(26px,3.5vw,36px);box-shadow:0 4px 20px rgba(60,40,30,.06);">
        ...
        <h3 style="margin:0 0 4px;font-size:var(--h3-l);font-weight:700;color:#003850;letter-spacing:-.01em;">PRP</h3>
        <p style="margin:0 0 14px;font-size:12px;font-weight:600;letter-spacing:var(--ls-label);text-transform:uppercase;color:rgba(51,51,52,.45);">Plasma riche en plaquettes</p>
        ...
        <div style="display:flex;flex-wrap:wrap;gap:6px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Tendinopathies</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Arthrose débutante</span></div>
      </div>
      <div style="background:#fff;border-radius:var(--r-l);padding:clamp(26px,3.5vw,36px);box-shadow:0 4px 20px rgba(60,40,30,.06);">
        <div style="width:52px;height:52px;border-radius:var(--r-m);background:rgba(4,164,155,.12);display:flex;align-items:center;justify-content:center;margin-bottom:18px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:26px;height:26px;color:#04A49B;"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/></svg></div>
        <h3 style="margin:0 0 4px;font-size:var(--h3-l);font-weight:700;color:#003850;letter-spacing:-.01em;">Viscosupplémentation</h3>
        <p style="margin:0 0 14px;font-size:12px;font-weight:600;letter-spacing:var(--ls-label);text-transform:uppercase;color:rgba(51,51,52,.45);">Acide hyaluronique</p>
        ...
        <div style="display:flex;flex-wrap:wrap;gap:6px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Arthrose</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Genou, hanche…</span></div>
      </div>
      <div style="background:#fff;border-radius:var(--r-l);padding:clamp(26px,3.5vw,36px);box-shadow:0 4px 20px rgba(60,40,30,.06);">
        <div style="width:52px;height:52px;border-radius:var(--r-m);background:rgba(243,190,121,.18);display:flex;align-items:center;justify-content:center;margin-bottom:18px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:26px;height:26px;color:#d49a40;"><path d="M12 3q1 4 4 6.5t3 5.5a1 1 0 0 1-14 0 5 5 0 0 1 1-3 1 1 0 0 0 5 0c0-2-1.5-3-1.5-5q0-2 2.5-4"/></svg></div>
        <h3 style="margin:0 0 4px;font-size:var(--h3-l);font-weight:700;color:#003850;letter-spacing:-.01em;">Corticoïdes</h3>
        <p style="margin:0 0 14px;font-size:12px;font-weight:600;letter-spacing:var(--ls-label);text-transform:uppercase;color:rgba(51,51,52,.45);">Anti-inflammatoire</p>
        ...
        <div style="display:flex;flex-wrap:wrap;gap:6px;"><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Douleur aiguë</span><span style="padding:5px 11px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Inflammation</span></div>
      </div>
    </div>
    <div style="display:flex;flex-wrap:wrap;gap:16px;justify-content:center;margin-top:32px;">
...
<section style="max-width:900px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,24px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:28px;align-items:center;">
    <div>
      <p style="margin:0 0 6px;font-size:12px;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;font-weight:600;">Sur rendez-vous</p>
      <h2 style="margin:0 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;">Un avis médical d’abord</h2>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="max-width:760px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Le principe</p>
    <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">« Peu, rarement, au bon endroit »</h2>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  ...
  <div style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;max-width:760px;margin:0 auto;">
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Tendinopathies</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Douleurs musculaires</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Entorses &amp; contractures</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Douleurs cervicales &amp; lombaires</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Récupération sportive</span>
  </div>
</section>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="text-align:center;margin-bottom:46px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Nos approches</p>
    <h2 style="font-family:'Bricolage Grotesque','Helvetica Neue',Helvetica,Arial,sans-serif;margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Une prépa pour chaque sportif</h2>
  </div>
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:20px;">
    <article style="background:#fff;border-radius:var(--r-l);padding:clamp(26px,3.4vw,34px);box-shadow:0 4px 20px rgba(60,40,30,.06);display:flex;flex-direction:column;">
      <div style="width:52px;height:52px;border-radius:var(--r-m);background:rgba(4,164,155,.1);display:flex;align-items:center;justify-content:center;margin-bottom:18px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:26px;height:26px;color:#04A49B;"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg></div>
      <h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#003850;letter-spacing:-.01em;">Préparation physique du danseur</h3>
    ...
    <article style="background:#fff;border-radius:var(--r-l);padding:clamp(26px,3.4vw,34px);box-shadow:0 4px 20px rgba(60,40,30,.06);display:flex;flex-direction:column;">
      ...
      <h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#003850;letter-spacing:-.01em;">Préparation physique du coureur</h3>
    ...
    <article style="background:#fff;border-radius:var(--r-l);padding:clamp(26px,3.4vw,34px);box-shadow:0 4px 20px rgba(60,40,30,.06);display:flex;flex-direction:column;">
      ...
      <h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#003850;letter-spacing:-.01em;">Préparation physique générale</h3>
    ...
    <article style="background:linear-gradient(150deg,#012A3A,#0A556B);border-radius:var(--r-l);padding:clamp(26px,3.4vw,34px);box-shadow:0 4px 20px rgba(0,40,56,.18);display:flex;flex-direction:column;color:#fff;">
      <div style="width:52px;height:52px;border-radius:var(--r-m);background:rgba(4,164,155,.22);display:flex;align-items:center;justify-content:center;margin-bottom:18px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:26px;height:26px;color:#04A49B;"><rect width="14" height="20" x="5" y="2" rx="2" ry="2"/><path d="M12 18h.01"/></svg></div>
      <h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;letter-spacing:-.01em;">Coaching sportif / santé à distance</h3>
...
<!-- ░░ TARIFS ░░ -->
<section style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,48px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:46px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Tarifs</p>
      <h2 style="font-family:'Bricolage Grotesque','Helvetica Neue',Helvetica,Arial,sans-serif;margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Nos formules de prépa physique</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:18px;">
      <a class="pp-form" href="/equipe">
        ...
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:22px;">
          <div style="display:flex;align-items:baseline;justify-content:space-between;gap:10px;"><h3 style="margin:0;font-size:var(--h3-m);font-weight:700;color:#fff;letter-spacing:-.01em;">Coaching personnalisé</h3><span style="font-size:22px;font-weight:800;color:#fff;">40 €/h</span></div>
          ...
          <span style="margin-top:14px;display:inline-flex;align-items:center;justify-content:center;gap:7px;padding:11px 16px;border-radius:var(--r-pill);background:#04A49B;color:#fff;font-size:13px;font-weight:600;">Réserver ma séance <span>↗</span></span>
        </div>
      </a>
      ...
      <a class="pp-form" href="mailto:contact@mugitu-biarritz.fr?subject=Devis%20coaching%20%C3%A0%20domicile">
        ...
        <div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(1,30,42,.95) 0%,rgba(1,30,42,.5) 46%,rgba(1,30,42,.05) 100%);"></div>
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:22px;">
          <div style="display:flex;align-items:baseline;justify-content:space-between;gap:10px;"><h3 style="margin:0;font-size:var(--h3-m);font-weight:700;color:#fff;letter-spacing:-.01em;">Séance à domicile</h3><span style="font-size:20px;font-weight:800;color:#fff;">Sur devis</span></div>
          ...
          <span style="margin-top:14px;display:inline-flex;align-items:center;justify-content:center;gap:7px;padding:11px 16px;border-radius:var(--r-pill);background:#04A49B;color:#fff;font-size:13px;font-weight:600;">Demander un devis <span>↗</span></span>
        </div>
      </a>
      <a class="pp-form" href="https://andrew.care" target="_blank" rel="noopener noreferrer">
        ...
        <span style="position:absolute;top:16px;right:16px;z-index:2;padding:5px 12px;border-radius:var(--r-pill);background:#F3BE79;color:#3a2a10;font-size:10px;font-weight:700;letter-spacing:var(--ls-label);text-transform:uppercase;">À distance</span>
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:22px;">
          <div style="display:flex;align-items:baseline;justify-content:space-between;gap:10px;"><h3 style="margin:0;font-size:var(--h3-m);font-weight:700;color:#fff;letter-spacing:-.01em;">Coaching santé à distance</h3><span style="font-size:20px;font-weight:800;color:#fff;">Dès 20 €/mois</span></div>
          ...
          <span style="margin-top:14px;display:inline-flex;align-items:center;justify-content:center;gap:7px;padding:11px 16px;border-radius:var(--r-pill);background:#04A49B;color:#fff;font-size:13px;font-weight:600;">Découvrir Andrew Coach <span>↗</span></span>
        </div>
      </a>
    </div>
...
<!-- ░░ SMALL GROUPS / KLUB ░░ -->
<section style="max-width:1000px;margin:0 auto;padding:var(--sect-ample) clamp(20px,5vw,40px);">
  <div style="background:linear-gradient(150deg,#04A49B,#0A556B);border-radius:var(--r-xl);padding:clamp(30px,5vw,52px);color:#fff;display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:28px;align-items:center;">
    <div>
      <div style="width:52px;height:52px;border-radius:var(--r-m);background:rgba(255,255,255,.16);display:flex;align-items:center;justify-content:center;margin-bottom:18px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:26px;height:26px;color:#fff;"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><path d="M16 3.128a4 4 0 0 1 0 7.744"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><circle cx="9" cy="7" r="4"/></svg></div>
      <h2 style="font-family:'Bricolage Grotesque','Helvetica Neue',Helvetica,Arial,sans-serif;margin:0 0 12px;font-size:var(--h2-m);font-weight:800;letter-spacing:-.02em;">Les small groups du Mugi Klub</h2>
    ...
    <div style="display:flex;flex-direction:column;gap:12px;align-items:flex-start;">
      <a href="/mugi-klub#planning" style="display:inline-flex;align-items:center;gap:8px;padding:15px 28px;border-radius:var(--r-pill);background:#fff;color:#003850;font-size:15px;font-weight:600;text-decoration:none;">Voir le planning <span>↗</span></a>
      <a href="/mugi-klub#tarifs" style="display:inline-flex;align-items:center;gap:8px;padding:15px 28px;border-radius:var(--r-pill);border:1px solid rgba(255,255,255,.4);color:#fff;font-size:15px;font-weight:600;text-decoration:none;">Tarifs du Klub <span>↗</span></a>
    </div>
  </div>
</section>
...
<section style="max-width:1100px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;">
    <div style="max-width:560px;margin-bottom:28px;">
      <p style="margin:0 0 6px;font-size:12px;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;font-weight:600;">L’équipe prépa physique</p>
      <h2 style="font-family:'Bricolage Grotesque','Helvetica Neue',Helvetica,Arial,sans-serif;margin:0 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;">Qui vous accompagne ?</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:14px;">
      <a href="/equipe/jean-baptiste-colombie" style="display:flex;align-items:center;gap:13px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:var(--r-m);padding:14px 16px;text-decoration:none;transition:background .2s;" class="mg-inline-hover"><img src="/jb-colombie.jpg" alt="Jean-Baptiste Colombié" style="width:48px;height:48px;border-radius:50%;object-fit:cover;object-position:center 25%;flex:0 0 auto;" /><div style="min-width:0;"><p style="margin:0;font-size:14px;font-weight:700;color:#fff;">Jean-Baptiste Colombié</p><p style="margin:0;font-size:12px;color:#04A49B;">Danseur</p></div></a>
      <a href="/equipe/marine-vignaud" style="display:flex;align-items:center;gap:13px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:var(--r-m);padding:14px 16px;text-decoration:none;transition:background .2s;" class="mg-inline-hover"><img src="/marine-vignaud.png" alt="Marine Vignaud" style="width:48px;height:48px;border-radius:50%;object-fit:cover;object-position:center 20%;flex:0 0 auto;" /><div style="min-width:0;"><p style="margin:0;font-size:14px;font-weight:700;color:#fff;">Marine Vignaud</p><p style="margin:0;font-size:12px;color:#04A49B;">Coureur · général</p></div></a><a href="/equipe/baptiste-caparros" style="display:flex;align-items:center;gap:13px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:var(--r-m);padding:14px 16px;text-decoration:none;transition:background .2s;" class="mg-inline-hover"><img src="/baptiste-caparros.webp" alt="Baptiste Caparros" style="width:48px;height:48px;border-radius:50%;object-fit:cover;object-position:center 22%;flex:0 0 auto;" /><div style="min-width:0;"><p style="margin:0;font-size:14px;font-weight:700;color:#fff;">Baptiste Caparros</p><p style="margin:0;font-size:12px;color:#04A49B;">Coureur · trail</p></div></a>
      <a href="/equipe/hugo-daminato" style="display:flex;align-items:center;gap:13px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:var(--r-m);padding:14px 16px;text-decoration:none;transition:background .2s;" class="mg-inline-hover"><img src="/hugo-daminato.png" alt="Hugo Daminato" style="width:48px;height:48px;border-radius:50%;object-fit:cover;object-position:center 20%;flex:0 0 auto;" /><div style="min-width:0;"><p style="margin:0;font-size:14px;font-weight:700;color:#fff;">Hugo Daminato</p><p style="margin:0;font-size:12px;color:#04A49B;">Général</p></div></a>
    </div>
  </div>
</section>`,
  },
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,60px);align-items:center;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">La méthode</p>
      <h2 style="margin:0 0 18px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Objectiver la performance et le risque</h2>
    ...
    <div style="border-radius:var(--r-l);overflow:hidden;aspect-ratio:4/3;box-shadow:0 14px 44px rgba(60,40,30,.14);background:#FDF8F4;"><img src="/vald-forcedecks.webp" alt="Plateformes de force VALD ForceDecks" style="width:100%;height:100%;object-fit:contain;" /></div>
  </div>
</section>
...
<section style="background:#F5EDE4;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:46px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Les tests disponibles</p>
      <h2 style="margin:0;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#003850;">Ce que l’on peut mesurer</h2>
    </div>
    <div class="vt-scroll">
      <div class="vt-card"><img src="/vald-forcedecks.webp" alt="Saut &amp; puissance" style="background:#012A3A;object-fit:contain;" /><div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(1,30,42,.96) 0%,rgba(1,30,42,.5) 42%,rgba(1,30,42,.1) 100%);"></div><div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:24px;"><span style="font-size:11px;font-weight:600;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;margin-bottom:8px;">ForceDecks</span><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#fff;letter-spacing:-.01em;">Saut &amp; puissance</h3><p class="vt-desc" style="margin:10px 0 0;font-size:14px;line-height:1.6;color:rgba(255,255,255,.85);">Countermovement jump, squat jump, drop jump&nbsp;: hauteur, puissance et asymétries gauche/droite.</p></div></div>

      <div class="vt-card"><img src="/vald-forceframe-1.webp" alt="Force isométrique" /><div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(1,30,42,.96) 0%,rgba(1,30,42,.5) 42%,rgba(1,30,42,.1) 100%);"></div><div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:24px;"><span style="font-size:11px;font-weight:600;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;margin-bottom:8px;">ForceFrame</span><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#fff;letter-spacing:-.01em;">Force isométrique max</h3><p class="vt-desc" style="margin:10px 0 0;font-size:14px;line-height:1.6;color:rgba(255,255,255,.85);">Hanche, genou, épaule, tronc&nbsp;: force maximale et déficits par groupe musculaire.</p></div></div>

      <div class="vt-card"><img src="/vald-forceframe-2.webp" alt="Ratios &amp; asymétries" /><div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(1,30,42,.96) 0%,rgba(1,30,42,.5) 42%,rgba(1,30,42,.1) 100%);"></div><div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:24px;"><span style="font-size:11px;font-weight:600;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;margin-bottom:8px;">ForceFrame</span><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#fff;letter-spacing:-.01em;">Ratios &amp; asymétries</h3><p class="vt-desc" style="margin:10px 0 0;font-size:14px;line-height:1.6;color:rgba(255,255,255,.85);">Ratios ischios/quadriceps et comparaison membre sain / membre lésé — clés du retour au sport.</p></div></div>

      <div class="vt-card"><img src="/vald-equilibre.jpg" alt="Équilibre &amp; stabilité" style="background:#012A3A;object-position:center;" /><div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(1,30,42,.96) 0%,rgba(1,30,42,.5) 42%,rgba(1,30,42,.1) 100%);"></div><div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:24px;"><span style="font-size:11px;font-weight:600;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;margin-bottom:8px;">ForceDecks</span><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#fff;letter-spacing:-.01em;">Équilibre &amp; stabilité</h3><p class="vt-desc" style="margin:10px 0 0;font-size:14px;line-height:1.6;color:rgba(255,255,255,.85);">Contrôle postural et appui unipodal pour évaluer la stabilité et le risque de blessure.</p></div></div>

      <div class="vt-card"><img src="/vald-dynamo.webp" alt="Amplitude articulaire" style="background:#FDF8F4;object-fit:contain;" /><div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(1,30,42,.96) 0%,rgba(1,30,42,.5) 42%,rgba(1,30,42,.1) 100%);"></div><div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:24px;"><span style="font-size:11px;font-weight:600;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;margin-bottom:8px;">DynaMo</span><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#fff;letter-spacing:-.01em;">Amplitude articulaire</h3><p class="vt-desc" style="margin:10px 0 0;font-size:14px;line-height:1.6;color:rgba(255,255,255,.85);">Mobilité et force en tout point de l’amplitude, au cabinet comme au bord du terrain.</p></div></div>

      <div class="vt-card"><img src="/vald-valdhub.webp" alt="Suivi dans le temps ValdHub" style="background:#FDF8F4;object-fit:cover;object-position:top center;" /><div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(1,30,42,.96) 0%,rgba(1,30,42,.5) 42%,rgba(1,30,42,.05) 100%);"></div><div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:24px;"><span style="font-size:11px;font-weight:600;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;margin-bottom:8px;">ValdHub</span><h3 style="margin:0;font-size:var(--h3-l);font-weight:700;color:#fff;letter-spacing:-.01em;">Suivi dans le temps</h3><p class="vt-desc" style="margin:10px 0 0;font-size:14px;line-height:1.6;color:rgba(255,255,255,.85);">Comparaison aux normes et évolution séance après séance, centralisées sur ValdHub.</p></div></div>
    </div>
  </div>
</section>
...
<section style="background:#003850;padding:var(--sect-ample) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:14px;">
      ...
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:var(--ls-eyebrow);text-transform:uppercase;font-weight:600;color:#04A49B;">Les appareils VALD®</p>
      <h2 style="margin:0 auto;max-width:640px;font-size:var(--h2-l);font-weight:700;letter-spacing:-.025em;color:#fff;">Les technologies de référence du sport professionnel</h2>
    </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px;">
      <a href="https://valdhealth.com/fr/products/forcedecks" target="_blank" rel="noopener noreferrer" style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:var(--r-l);overflow:hidden;display:flex;flex-direction:column;text-decoration:none;transition:transform .2s,background .2s;" class="mg-inline-hover">
        <div style="aspect-ratio:16/10;background:#012A3A;overflow:hidden;"><img src="/vald-forcedecks.webp" alt="VALD ForceDecks" style="width:100%;height:100%;object-fit:contain;" /></div>
        <div style="padding:24px;"><h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#fff;">ForceDecks <span style="font-size:13px;color:#04A49B;">↗</span></h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(255,255,255,.65);">Plateformes de force jumelées&nbsp;: sauts, équilibre, puissance et asymétries gauche/droite mesurés au millimètre — le test de référence du retour au sport.</p></div>
      </a>

      <a href="https://valdhealth.com/fr/products/forceframe" target="_blank" rel="noopener noreferrer" style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:var(--r-l);overflow:hidden;display:flex;flex-direction:column;text-decoration:none;transition:transform .2s,background .2s;" class="mg-inline-hover">
        <div style="aspect-ratio:16/10;background:#012A3A;overflow:hidden;"><img src="/vald-forceframe-1.webp" alt="VALD ForceFrame" style="width:100%;height:100%;object-fit:cover;" /></div>
        <div style="padding:24px;"><h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#fff;">ForceFrame <span style="font-size:13px;color:#04A49B;">↗</span></h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(255,255,255,.65);">Cadre de testing isométrique&nbsp;: force maximale, ratios musculaires et asymétries sur une large batterie de tests (hanche, genou, épaule…).</p></div>
      </a>

      <a href="https://valdhealth.com/fr/products/dynamo" target="_blank" rel="noopener noreferrer" style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:var(--r-l);overflow:hidden;display:flex;flex-direction:column;text-decoration:none;transition:transform .2s,background .2s;" class="mg-inline-hover">
        <div style="aspect-ratio:16/10;background:#012A3A;overflow:hidden;"><img src="/vald-forceframe-2.webp" alt="VALD DynaMo" style="width:100%;height:100%;object-fit:cover;" /></div>
        <div style="padding:24px;"><h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#fff;">DynaMo <span style="font-size:13px;color:#04A49B;">↗</span></h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(255,255,255,.65);">Dynamomètre portable et polyvalent&nbsp;: force et amplitude articulaire mesurées partout, du cabinet au bord du terrain.</p></div>
      </a>
      ...
      <a href="https://valdhealth.com/fr/products/movehealth" target="_blank" rel="noopener noreferrer" style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:var(--r-l);overflow:hidden;display:flex;flex-direction:column;text-decoration:none;transition:transform .2s,background .2s;" class="mg-inline-hover">
        ...
        <div style="padding:24px;"><h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#fff;">MoveHealth <span style="font-size:13px;color:#04A49B;">↗</span></h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(255,255,255,.65);">Évaluation de la mobilité et de l’amplitude par capture vidéo&nbsp;: une analyse objective du mouvement, sans capteur.</p></div>
      </a>

      <article style="background:linear-gradient(150deg,#04A49B,#0A556B);border-radius:var(--r-l);padding:28px;display:flex;flex-direction:column;justify-content:center;">
        <div style="width:48px;height:48px;border-radius:var(--r-s);background:rgba(255,255,255,.16);display:flex;align-items:center;justify-content:center;margin-bottom:16px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:24px;height:24px;color:#fff;"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"/></svg></div>
        <h3 style="margin:0 0 8px;font-size:var(--h3-m);font-weight:700;color:#fff;">Un plateau technique complet</h3>
        ...
        <a href="/equipe" style="display:inline-flex;align-self:flex-start;align-items:center;gap:8px;padding:12px 22px;border-radius:var(--r-pill);background:#fff;color:#003850;font-size:14px;font-weight:600;text-decoration:none;">Prendre rendez-vous <span>↗</span></a>
      </article>
    </div>
  </div>
</section>
...
<section style="max-width:1140px;margin:0 auto;padding:var(--sect-base) clamp(20px,5vw,40px);">
  ...
  <div style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;max-width:760px;margin:0 auto;">
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Retour au sport post-blessure</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Détection d’asymétries</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Suivi de force</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Prévention</span>
    <span style="padding:10px 20px;border-radius:var(--r-pill);background:rgba(4,164,155,.1);color:#04A49B;font-size:15px;font-weight:600;">Bilan de performance</span>
  </div>
</section>
...
<section style="max-width:1140px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:var(--r-xl);padding:clamp(28px,4vw,44px);color:#fff;">
    <div style="max-width:560px;margin-bottom:28px;">
      <p style="margin:0 0 6px;font-size:12px;letter-spacing:var(--ls-label);text-transform:uppercase;color:#04A49B;font-weight:600;">Testing du sportif · Vald®</p>
      <h2 style="margin:0 0 12px;font-size:var(--h2-s);font-weight:700;letter-spacing:-.02em;">Qui réalise votre bilan ?</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;">
      ...
      <a href="/equipe/marine-vignaud" style="display:flex;align-items:center;gap:13px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:var(--r-m);padding:14px 16px;text-decoration:none;transition:background .2s;" class="mg-inline-hover">
      ...
      <a href="/equipe" style="display:flex;align-items:center;justify-content:center;gap:8px;background:#04A49B;border-radius:var(--r-m);padding:14px 16px;text-decoration:none;font-size:14px;font-weight:600;color:#fff;transition:background .2s;" class="mg-inline-hover">Voir tous les créneaux <span>↗</span></a>
    </div>
  </div>
</section>
