...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  ...
  },
  {
    ...
    trail: [{ label: `Accueil`, href: "/" }],
    cta: "/equipe",
    titleSize: "clamp(34px,5.4vw,68px)",
    titleLineHeight: ".98",
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Le bon moment pour agir</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le déroulé</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Une consultation en quatre temps</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Les volets</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Trois plans, une même saison</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Volet 1</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Médical</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Aptitude, dépistage cardio-vasculaire, gestion des pathologies chroniques et des traitements. C'est le socle, et le seul volet qui peut conclure à une contre-indication.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Aptitude</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Cardio-vasculaire</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Certificat</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Volet 2</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Physique</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Testing de force et de mobilité, identification des asymétries et des déficits, programme de préparation physique pour les semaines qui précèdent la reprise.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Testing</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Asymétries</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Programme</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Volet 3</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Nutrition et mental</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Apports et énergie disponible, hydratation, sommeil, gestion du stress et objectifs de saison. Proposés selon le profil et la discipline.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Énergie disponible</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Sommeil</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Objectifs</span></div></div></div>
  </div>
...
<section id="science" style="background:#003850;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:620px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Ce que dit la science</p>
      <h2 style="margin:0;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#fff;">Sur quoi repose ce bilan</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px;">
...
<section id="urgence" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="background:rgba(238,128,108,.1);border-radius:24px;padding:clamp(26px,4vw,40px);display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:26px;align-items:start;">
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:28px;height:28px;color:#EE806C;"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>
      <h2 style="margin:14px 0 12px;font-size:clamp(22px,3vw,30px);font-weight:700;letter-spacing:-.02em;color:#003850;">Ce que ce bilan ne fait pas</h2>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">La saison commence bientôt ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">La sensation arrive avant la capacité</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le déroulé</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Une séance, quatre familles de tests</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Ce qu'on mesure</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Les seuils qui font référence</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Critère 1</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Symétrie de force</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Objectif classique : plus de 90 % du côté sain en force isométrique. C'est le critère le plus souvent manquant au moment où le sportif se sent prêt à reprendre.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Dynamomètre</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Ratio > 90 %</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Comparaison bilatérale</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Critère 2</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Qualité des sauts</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Symétrie des distances mais aussi qualité de l'amorti et du contrôle du genou. Un saut équivalent en distance peut être très différent en qualité.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Hop tests</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Amorti</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Contrôle</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Critère 3</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Confiance</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Score au questionnaire d'appréhension. Un score bas oriente vers un travail progressif d'exposition, parfois avec un accompagnement psychologique.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Questionnaire</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Appréhension</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Exposition graduée</span></div></div></div>
  </div>
...
<section id="science" style="background:#003850;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:620px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Ce que dit la science</p>
      <h2 style="margin:0;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#fff;">Sur quoi reposent ces critères</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px;">
...
<section style="max-width:1140px;margin:0 auto;padding:0 clamp(20px,5vw,40px) clamp(50px,7vw,80px);">
  <p style="margin:0 0 20px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">À lire ensuite</p>
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:16px;">
    <a href="/pathologies/reeducation-lca" style="background:#fff;border-radius:18px;padding:24px;box-shadow:0 4px 20px rgba(60,40,30,.06);text-decoration:none;display:block;transition:transform .2s;" class="mg-inline-hover"><h3 style="margin:0 0 8px;font-size:17px;font-weight:700;color:#003850;">Rééducation du LCA</h3><p style="margin:0;font-size:14px;line-height:1.6;color:rgba(51,51,52,.62);">Le parcours complet, étape par étape.</p></a>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Prêt à reprendre, vraiment ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Ce n'est pas une leçon de technique</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le déroulé</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Une séance en quatre temps</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Ce qu'on mesure</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Les paramètres qui comptent vraiment</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Paramètre 1</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">La cadence</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Le nombre de pas par minute conditionne directement les charges au genou et à la hanche. C'est le levier le plus simple à ajuster et l'un des plus efficaces.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Pas par minute</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Charges articulaires</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Ajustement simple</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Paramètre 2</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">La charge d'entraînement</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Volume, dénivelé, densité des séances sur les six dernières semaines. La cause de la blessure est presque toujours ici, pas dans la vidéo.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Volume</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Dénivelé</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Progression</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Paramètre 3</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">La capacité musculaire</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Force du mollet, des quadriceps, tolérance aux sauts. C'est ce qui détermine combien votre corps peut encaisser d'impacts.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Force du mollet</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Sauts</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Symétrie</span></div></div></div>
  </div>
...
<section id="science" style="background:#003850;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:620px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Ce que dit la science</p>
      <h2 style="margin:0;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#fff;">Sur quoi repose le bilan</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px;">
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Envie de comprendre votre foulée ?</h2>
