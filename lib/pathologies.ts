...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      ...
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Un ligament, mais surtout un genou à reconstruire</h2>
    ...
    <div style="background:#F5EDE4;border-radius:20px;padding:28px;">
      <p style="margin:0 0 16px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#003850;">Ce qui structure le parcours</p>
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le parcours</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Les quatre étapes de la rééducation</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">La décision</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Sur quoi on autorise la reprise</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Critère 1</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">La force</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Force du quadriceps et des ischio-jambiers à plus de 90 % du côté sain, mesurée au dynamomètre. C'est le critère le plus souvent manquant au moment où le sportif se sent prêt.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Dynamomètre</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Symétrie > 90 %</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Quadriceps</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Critère 2</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Les sauts</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Batterie de hop tests : saut simple, triple, saut latéral, avec une symétrie et une qualité d'amorti comparables des deux côtés.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Hop tests</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Amorti</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Contrôle du genou</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Critère 3</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">La confiance</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Questionnaire de confiance et d'appréhension. Un genou fort mais redouté expose autant à la récidive qu'un genou faible.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Questionnaire ACL-RSI</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Appréhension</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Décision partagée</span></div></div></div>
  </div>
...
<section id="science" style="background:#003850;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:620px;">
      ...
      <h2 style="margin:0;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#fff;">Sur quoi repose cette prise en charge</h2>
    </div>
...
<section id="urgence" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="background:rgba(238,128,108,.1);border-radius:24px;padding:clamp(26px,4vw,40px);display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:26px;align-items:start;">
    <div>
      ...
      <h2 style="margin:14px 0 12px;font-size:clamp(22px,3vw,30px);font-weight:700;letter-spacing:-.02em;color:#003850;">Quand reconsulter rapidement</h2>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Une reprise après LCA à sécuriser ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Un tendon dépassé, pas un tendon enflammé</h2>
    ...
    <div style="background:#F5EDE4;border-radius:20px;padding:28px;">
      <p style="margin:0 0 16px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#003850;">Les signes qui parlent</p>
      <div style="display:flex;flex-direction:column;gap:14px;">
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Au cabinet</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Comment on pose le diagnostic</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Trois phases, une seule logique : recharger</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:minmax(160px,.5fr) minmax(240px,2fr);gap:22px;align-items:start;">
      <div><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · 1 à 3 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Calmer sans arrêter</h3></div>
      <div><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">On réduit ce qui pique — côtes, fractionné, gros volumes — sans supprimer la course si elle reste sous le seuil de douleur toléré. On installe le travail isométrique du mollet, qui apaise souvent la douleur dès les premières séances.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Isométrie</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Ajustement de charge</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Talonnette temporaire</span></div></div>
    </div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:minmax(160px,.5fr) minmax(240px,2fr);gap:22px;align-items:start;">
      <div><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · 4 à 12 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Reconstruire la capacité</h3></div>
      <div><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Renforcement lourd et lent, genou tendu puis genou fléchi, trois séances par semaine. La charge augmente quand la douleur du lendemain matin reste stable. C'est la phase la plus longue et la plus décisive : elle demande de la régularité plus que de l'intensité.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Heavy slow resistance</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mobilité cheville</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Suivi chiffré</span></div></div>
    </div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:minmax(160px,.5fr) minmax(240px,2fr);gap:22px;align-items:start;">
      <div><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · dès 8 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Retrouver l'élasticité</h3></div>
      <div><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Sauts, rebonds, puis reprise structurée de la course : plat d'abord, allure facile, volume rendu progressivement. Le dénivelé et le fractionné reviennent en dernier. Une analyse de foulée sert souvent ici à corriger ce qui a déclenché la blessure.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Pliométrie</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Retour à la course</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Analyse de foulée</span></div></div>
    </div>
  </div>
...
<section id="science" style="background:#003850;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px;">
      <div style="background:rgba(255,255,255,.06);border-radius:18px;padding:26px;">
        <span style="display:inline-block;padding:4px 10px;border-radius:999px;background:rgba(4,164,155,.2);color:#5fd6cf;font-size:11px;font-weight:700;margin-bottom:14px;">Alfredson · 1998</span>
      ...
      <div style="background:rgba(255,255,255,.06);border-radius:18px;padding:26px;">
        <span style="display:inline-block;padding:4px 10px;border-radius:999px;background:rgba(4,164,155,.2);color:#5fd6cf;font-size:11px;font-weight:700;margin-bottom:14px;">Beyer et al. · AJSM 2015</span>
      ...
      <div style="background:rgba(255,255,255,.06);border-radius:18px;padding:26px;">
        <span style="display:inline-block;padding:4px 10px;border-radius:999px;background:rgba(4,164,155,.2);color:#5fd6cf;font-size:11px;font-weight:700;margin-bottom:14px;">Silbernagel et al. · 2007</span>
...
<section id="urgence" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="background:rgba(238,128,108,.1);border-radius:24px;padding:clamp(26px,4vw,40px);display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:26px;align-items:start;">
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:28px;height:28px;color:#EE806C;"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>
      <h2 style="margin:14px 0 12px;font-size:clamp(22px,3vw,30px);font-weight:700;letter-spacing:-.02em;color:#003850;">Quand consulter sans attendre</h2>
...
<section id="faq" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:860px;margin:0 auto;">
    ...
    <div style="display:flex;flex-direction:column;gap:14px;">
      <div style="background:#fff;border-radius:18px;padding:26px;box-shadow:0 4px 20px rgba(60,40,30,.06);">
...
<section style="max-width:1140px;margin:0 auto;padding:0 clamp(20px,5vw,40px) clamp(50px,7vw,80px);">
  <p style="margin:0 0 20px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">À lire ensuite</p>
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:16px;">
    <a href="/methodes/clinique-du-coureur" style="background:#fff;border-radius:18px;padding:24px;box-shadow:0 4px 20px rgba(60,40,30,.06);text-decoration:none;display:block;transition:transform .2s;" class="mg-inline-hover">
    ...
    <a href="/methodes/testing-vald" style="background:#fff;border-radius:18px;padding:24px;box-shadow:0 4px 20px rgba(60,40,30,.06);text-decoration:none;display:block;transition:transform .2s;" class="mg-inline-hover">
    ...
    <a href="/soins/osteopathie" style="background:#fff;border-radius:18px;padding:24px;box-shadow:0 4px 20px rgba(60,40,30,.06);text-decoration:none;display:block;transition:transform .2s;" class="mg-inline-hover">
    ...
    <a href="/soins/medecine-du-sport" style="background:#fff;border-radius:18px;padding:24px;box-shadow:0 4px 20px rgba(60,40,30,.06);text-decoration:none;display:block;transition:transform .2s;" class="mg-inline-hover">
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Une douleur d'Achille qui traîne ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Un carrefour de contraintes</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Au cabinet</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Trouver quelle structure parle</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Renforcer les adducteurs, pas les étirer</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · 2 à 4 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Baisser l'irritabilité</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">On retire temporairement les gestes déclencheurs — sprints, frappes, changements de direction — sans arrêter toute activité. Isométries d'adduction et travail du tronc en douceur.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Isométrie adducteurs</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Gainage</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Ajustement de charge</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · 4 à 10 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Charger progressivement</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Renforcement excentrique et concentrique des adducteurs, type protocole Copenhague, associé au travail des abdominaux profonds et des fessiers. Trois séances par semaine.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Copenhagen adduction</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Fessiers</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Tronc</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · dès 8 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Retour au terrain</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Réintroduction des courses, appuis, frappes puis contacts, dans cet ordre. Les critères de reprise sont un squeeze test indolore et une force d'adduction symétrique.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Course</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Appuis</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Retour au jeu</span></div></div></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Une douleur d'aine qui dure ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Une cheville qui perd ses repères</h2>
    ...
    <div style="background:#F5EDE4;border-radius:20px;padding:28px;">
      <p style="margin:0 0 16px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#003850;">Ce qu'on évalue</p>
      <div style="display:flex;flex-direction:column;gap:14px;">
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Au cabinet</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Radio ou pas radio ?</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Bouger tôt, rééduquer longtemps</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · 3 à 7 jours</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Protéger et remettre en charge</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Protection relative, glace si elle soulage, compression, surélévation. On remarche dès que possible, avec une attelle ou un strap si nécessaire. L'appui précoce est un facteur de bonne récupération.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Protection</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Appui précoce</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Attelle</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · 1 à 4 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Mobilité et force</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Récupération de la flexion de cheville, renforcement des fibulaires et du triceps, travail de l'équilibre sur une jambe, d'abord au sol puis sur surface instable.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mobilité</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Fibulaires</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Proprioception</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · 4 à 8 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Retour au terrain</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Sauts, changements de direction, gestes du sport pratiqué. La reprise se décide sur des critères de force et d'équilibre, pas sur un délai au calendrier.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Pliométrie</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Appuis</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Retour au sport</span></div></div></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Une cheville qui se tord trop souvent ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Un muscle surpris en pleine vitesse</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Au cabinet</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Évaluer sans surinterpréter</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Charger tôt, sprinter tard</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · 3 à 7 jours</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Protéger et remobiliser</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Protection courte, marche normale dès que possible, contractions douces et sans douleur. On évite les étirements agressifs, qui retardent la cicatrisation.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Protection courte</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mobilisation douce</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Pas d'étirement forcé</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · 1 à 5 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Renforcer en longueur</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Excentrique progressif — nordic hamstring, extensions de hanche, travail en amplitude longue — associé au renforcement du tronc et des fessiers. La charge augmente chaque semaine tant que la douleur reste absente.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Nordic hamstring</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Amplitude longue</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Fessiers</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · dès 3 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Remonter la vitesse</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Réintroduction graduée de la course puis du sprint, par paliers de pourcentage de vitesse maximale. Le sprint à pleine vitesse est le dernier critère validé avant la compétition.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Course</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Sprint progressif</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Retour au sport</span></div></div></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Un ischio qui a lâché ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">L'os qui proteste</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Au cabinet</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Périostite ou fracture de fatigue ?</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Réduire l'impact, renforcer le mollet</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · 1 à 3 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Baisser l'impact</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Réduction du volume de course, bascule partielle sur vélo ou natation, surfaces plus souples. On garde de l'activité : l'arrêt total fait perdre la capacité osseuse et musculaire.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Volume réduit</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Cross-training</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Surface souple</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · 3 à 8 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Construire la jambe</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Renforcement du triceps et des muscles du pied, travail en charge progressive, puis sauts légers. On augmente aussi la cadence de course de quelques pas par minute pour diminuer l'impact.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mollet</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Pied</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Cadence</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · dès 6 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Remonter le kilométrage</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Progression du volume par paliers modestes, une variable à la fois. Le dénivelé et les surfaces dures reviennent en dernier.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Progression</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Une variable à la fois</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Suivi</span></div></div></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Des tibias qui brûlent à chaque sortie ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Un problème de charge, pas de rotule mal placée</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Renforcer la hanche autant que le genou</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · 1 à 3 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Faire baisser l'irritabilité</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">On réduit ce qui provoque la douleur — descentes, escaliers, longues sorties — sans arrêter l'activité. Le travail isométrique du quadriceps est bien toléré et soulage souvent dès la première semaine.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Isométrie</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Ajustement de charge</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Cadence de course</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · 3 à 10 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Reconstruire la force</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Renforcement progressif du quadriceps sur amplitude tolérée, puis travail des abducteurs et rotateurs de hanche. Deux à trois séances par semaine, avec une charge qui augmente tant que la douleur du lendemain reste stable.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Quadriceps</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Fessiers</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Contrôle moteur</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · dès 6 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Revenir à la course</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Reprise sur terrain plat, allure facile, volume rendu progressivement. Une cadence légèrement plus élevée réduit la charge au genou et facilite souvent la reprise. Le dénivelé négatif revient en dernier.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Retour à la course</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Cadence</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Pliométrie</span></div></div></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Un genou qui pique en descente ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Un tendon sous-préparé, pas un coude usé</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Au cabinet</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Confirmer, et écarter le reste</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Charger le tendon, progressivement</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · 1 à 3 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Calmer</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Adaptation temporaire des gestes provoquants, isométries d'extension du poignet, éventuellement une bracelet épicondylien pour les tâches obligatoires.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Isométrie</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Adaptation des gestes</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Bracelet</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · 3 à 12 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Renforcer</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Renforcement excentrique et lourd-lent des extenseurs, puis de toute la chaîne épaule-scapula, très souvent déficitaire. Trois séances par semaine, sur plusieurs mois.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Excentrique</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Chaîne scapulaire</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Préhension</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · dès 8 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Retour aux gestes</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Reprise progressive du sport ou du travail manuel, avec vérification du matériel : taille de manche, tension de cordage, poste de travail.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Matériel</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Reprise graduée</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Entretien</span></div></div></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Un coude qui gêne à chaque geste ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Une lame fibreuse débordée</h2>
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Au cabinet</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Un diagnostic clinique</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Charger le pied, étirer le mollet, gérer la charge</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · 2 à 6 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Soulager</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Réduction temporaire de la course et de la station debout prolongée, travail de mobilité du mollet, éventuellement une talonnette ou une semelle de confort. Auto-massage plantaire avant le lever.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mobilité mollet</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Semelle de confort</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Ajustement de charge</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · 6 à 16 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Renforcer en charge</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Renforcement lourd et lent du triceps et de l'aponévrose, orteils surélevés, tous les deux jours. C'est le protocole le mieux documenté et il demande de la constance.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Heavy slow resistance</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Triceps sural</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Muscles intrinsèques</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · dès 3 mois</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Reprendre la course</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Retour progressif au volume, surfaces souples d'abord, dénivelé en dernier. Le travail de renforcement continue en entretien pendant la reprise.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Reprise progressive</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Entretien</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Chaussage</span></div></div></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Un talon qui vous réveille chaque matin ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Un os qui n'a pas eu le temps de s'adapter</h2>
    ...
    <div style="background:#F5EDE4;border-radius:20px;padding:28px;">
      <p style="margin:0 0 16px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#003850;">Ce qui doit alerter</p>
      <div style="display:flex;flex-direction:column;gap:14px;">
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Au cabinet</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Confirmer vite, sans perdre de temps</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Décharger, puis recharger</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · 2 à 8 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Mise en décharge</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Arrêt des impacts, avec parfois des béquilles ou une botte selon la localisation. Les sites à risque, comme le col fémoral ou le sacrum, imposent une prudence particulière et un avis spécialisé.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Décharge</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Avis spécialisé</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Consolidation</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · en parallèle</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Maintenir la condition</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Vélo, natation, renforcement sans impact, travail du haut du corps. On corrige en même temps les causes : apports alimentaires, sommeil, planification de la charge.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Cross-training</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Nutrition</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Sommeil</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · après validation</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Retour aux impacts</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Reprise en marche-course, puis course continue, avec des paliers courts et une règle simple : aucune douleur pendant, ni le lendemain.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Marche-course</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Paliers</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Zéro douleur</span></div></div></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Une douleur osseuse qui s'aggrave ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Un dos sensible, pas un dos abîmé</h2>
    ...
    <div style="background:#F5EDE4;border-radius:20px;padding:28px;">
      <p style="margin:0 0 16px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#003850;">Ce qu'on regarde</p>
      <div style="display:flex;flex-direction:column;gap:14px;">
...
<section id="diagnostic" style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:40px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Au cabinet</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Ce qui est utile, ce qui ne l'est pas</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Reprendre, charger, renforcer</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · quelques jours</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Passer le cap douloureux</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">On garde une activité adaptée plutôt que le lit. Thérapie manuelle et mobilisations peuvent soulager à court terme et faciliter la remise en mouvement, sans être un traitement de fond.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Rester actif</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Thérapie manuelle</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Explications</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · 2 à 8 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Réexposer au mouvement</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">On revient sur les mouvements évités — flexion, rotation, port de charge — par doses progressives. Le renforcement du tronc, des fessiers et des ischio-jambiers reprend en parallèle.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Réexposition</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Renforcement</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mobilité de hanche</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · dès 6 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Remonter la charge sportive</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Retour aux gestes du sport, puis à l'intensité. On planifie la progression semaine par semaine, avec une marge : la récidive vient presque toujours d'une reprise trop rapide.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Charge d'entraînement</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Gestes spécifiques</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Prévention</span></div></div></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Un dos qui bloque votre saison ?</h2>
...
<section id="comprendre" style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:clamp(28px,4vw,56px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Comprendre</p>
      <h2 style="margin:0 0 18px;font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.025em;color:#003850;">Une épaule qui rame plus qu'elle ne peut</h2>
...
<section id="traitement" style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="margin-bottom:40px;max-width:660px;">
    <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le traitement</p>
    <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Renforcer la coiffe, réorganiser les sessions</h2>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 1 · 1 à 3 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Calmer sans arrêter l'eau</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">On réduit le volume de rame plutôt que de sortir de l'eau : sessions plus courtes, spots moins engagés, éventuellement une planche plus volumineuse. Isométries de rotation externe et travail de mobilité thoracique.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Isométrie</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Volume de rame</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Mobilité thoracique</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 2 · 3 à 10 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Construire la capacité</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Renforcement de la coiffe et des stabilisateurs de scapula, deux à trois fois par semaine, avec une charge qui progresse. On ajoute le travail de tirage et de gainage antérieur, très sollicité à la rame.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Coiffe</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Scapula</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Tirage</span></div></div></div>
    <div style="background:#fff;border-radius:20px;padding:28px;box-shadow:0 4px 20px rgba(60,40,30,.06);display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;align-items:start;"><div style="flex:0 0 auto;"><p style="margin:0 0 6px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:#04A49B;">Phase 3 · dès 8 semaines</p><h3 style="margin:0;font-size:20px;font-weight:700;color:#003850;">Retour aux sessions longues</h3></div><div style="grid-column:span 2;min-width:240px;"><p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:rgba(51,51,52,.7);">Remontée progressive du temps de rame et de la densité de sessions. On garde deux séances de renforcement par semaine en entretien pendant la saison de houle.</p><div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Reprise progressive</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Entretien</span><span style="padding:5px 11px;border-radius:999px;background:rgba(4,164,155,.1);color:#04A49B;font-size:12px;font-weight:600;">Prévention</span></div></div></div>
  </div>
...
<section style="max-width:900px;margin:0 auto;padding:0 clamp(20px,5vw,24px) clamp(56px,8vw,90px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">Une épaule qui pique à la rame ?</h2>
