...
export const INSTITUTIONNEL: ContentPage[] = [
  {
    ...
    cta: "/equipe",
    titleSize: "clamp(40px,7vw,80px)",
    titleLineHeight: ".95",
    bodyHtml: `<!-- FAQ -->
<section style="max-width:820px;margin:0 auto;padding:clamp(44px,6vw,72px) clamp(20px,5vw,40px);">

  <p style="margin:0 0 16px;font-size:12px;letter-spacing:.2em;text-transform:uppercase;font-weight:600;color:#04A49B;">Rendez-vous &amp; soins</p>
  <div style="display:flex;flex-direction:column;gap:12px;margin-bottom:40px;">
    <div class="faq-item" data-open="1" style="background:#fff;border-radius:16px;box-shadow:0 3px 16px rgba(60,40,30,.06);overflow:hidden;">
    ...
    <div class="faq-item" data-open="0" style="background:#fff;border-radius:16px;box-shadow:0 3px 16px rgba(60,40,30,.06);overflow:hidden;">
  ...
  <p style="margin:0 0 16px;font-size:12px;letter-spacing:.2em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le Mugi Klub</p>
  <div style="display:flex;flex-direction:column;gap:12px;margin-bottom:40px;">
    <div class="faq-item" data-open="0" style="background:#fff;border-radius:16px;box-shadow:0 3px 16px rgba(60,40,30,.06);overflow:hidden;">
  ...
  <p style="margin:0 0 16px;font-size:12px;letter-spacing:.2em;text-transform:uppercase;font-weight:600;color:#04A49B;">Espace &amp; app</p>
  ...
  <!-- contact -->
  <div style="background:#003850;border-radius:20px;padding:clamp(28px,4vw,40px);text-align:center;color:#fff;">
    <h2 style="margin:0 0 10px;font-size:clamp(20px,2.6vw,26px);font-weight:700;letter-spacing:-.01em;">Une autre question ?</h2>
    ...
    <a href="mailto:contact@mugitu-biarritz.fr" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;border-radius:999px;background:#04A49B;color:#fff;font-size:15px;font-weight:600;text-decoration:none;">contact@mugitu-biarritz.fr <span>↗</span></a>
  </div>
</section>`,
  },
  {
    ...
    trail: [{ label: `Accueil`, href: "/" }],
    cta: "/equipe",
    titleSize: "clamp(36px,6vw,64px)",
    titleLineHeight: ".98",
    bodyHtml: `<section class="lg" style="max-width:820px;margin:0 auto;padding:clamp(40px,6vw,64px) clamp(20px,5vw,40px);">
  ...
  },
  {
    ...
    trail: [{ label: `Accueil`, href: "/" }],
    cta: "/equipe",
    titleSize: "clamp(34px,5.5vw,60px)",
    titleLineHeight: "1",
    bodyHtml: `<section class="lg" style="max-width:820px;margin:0 auto;padding:clamp(40px,6vw,64px) clamp(20px,5vw,40px);">
  <p style="font-size:13px;color:rgba(51,51,52,.5);">Dernière mise à jour : 1er juillet 2026</p>
  ...
  },
  {
    ...
    trail: [],
    cta: "/equipe",
    titleSize: "clamp(44px,9vw,110px)",
    titleLineHeight: ".9",
...
<section style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,90px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:24px;">
    ...
    <article style="position:relative;border-radius:20px;overflow:hidden;aspect-ratio:3/4;box-shadow:0 6px 28px rgba(60,40,30,.1);grid-column:span 1;">
      ...
      <div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:26px;">
        ...
        <p style="margin:0;font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#04A49B;font-weight:600;">Surf de gros · foil</p>
        <h3 style="margin:2px 0 0;font-size:20px;font-weight:700;color:#fff;">Matt Etxebarne</h3>
      </div>
    </article>

    <article style="position:relative;border-radius:20px;overflow:hidden;aspect-ratio:3/4;box-shadow:0 6px 28px rgba(60,40,30,.1);background:#012A3A;">
      ...
      <div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:26px;pointer-events:none;">
        ...
        <p style="margin:0;font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#04A49B;font-weight:600;">Trail · ultra</p>
        <h3 style="margin:2px 0 0;font-size:20px;font-weight:700;color:#fff;">Damien San Martin</h3>
      </div>
    </article>

    <article style="position:relative;border-radius:20px;overflow:hidden;aspect-ratio:3/4;box-shadow:0 6px 28px rgba(60,40,30,.1);">
    ...
    <article style="border-radius:20px;background:linear-gradient(150deg,#003850,#0A556B);box-shadow:0 6px 28px rgba(0,40,56,.18);display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;padding:32px;aspect-ratio:3/4;color:#fff;">
      ...
      <a href="mailto:contact@mugitu-biarritz.fr" style="padding:12px 24px;border-radius:999px;background:#04A49B;color:#fff;font-size:14px;font-weight:600;text-decoration:none;">Nous contacter ↗</a>
    </article>
...
<!-- ░░ FOOTER ░░ -->`,
  },
  {
    ...
    bodyHtml: `<section style="max-width:1140px;margin:0 auto;padding:clamp(50px,7vw,80px) clamp(20px,5vw,40px);">
...
<section style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:38px;max-width:660px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Depuis chez vous</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Combien de temps pour venir</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:16px;">
      <div style="background:#fff;border-radius:18px;padding:24px;box-shadow:0 4px 20px rgba(60,40,30,.06);">
...
<section style="max-width:1140px;margin:0 auto;padding:clamp(60px,8vw,100px) clamp(20px,5vw,40px);">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:clamp(24px,4vw,50px);align-items:start;">
    <div>
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Sur place</p>
      <h2 style="margin:0 0 14px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;color:#003850;">Ce que vous trouvez au cabinet</h2>
    ...
    <div style="border-radius:20px;overflow:hidden;box-shadow:0 14px 44px rgba(60,40,30,.14);">
...
<section style="background:#003850;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:1140px;margin:0 auto;">
    <div style="margin-bottom:36px;max-width:620px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Le tissu sportif local</p>
      <h2 style="margin:0 0 14px;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#fff;">Les sports qu'on suit ici</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:16px;">
      <a href="/sports/surf" style="background:rgba(255,255,255,.06);border-radius:18px;padding:24px;text-decoration:none;display:block;transition:background .2s;" class="mg-inline-hover">
      ...
      <a href="/sports/trail-et-course" style="background:rgba(255,255,255,.06);border-radius:18px;padding:24px;text-decoration:none;display:block;transition:background .2s;" class="mg-inline-hover">
      ...
      <a href="/sports/rugby" style="background:rgba(255,255,255,.06);border-radius:18px;padding:24px;text-decoration:none;display:block;transition:background .2s;" class="mg-inline-hover">
      ...
      <a href="/sports/pelote-basque" style="background:rgba(255,255,255,.06);border-radius:18px;padding:24px;text-decoration:none;display:block;transition:background .2s;" class="mg-inline-hover">
      ...
      <a href="/sports/danse" style="background:rgba(255,255,255,.06);border-radius:18px;padding:24px;text-decoration:none;display:block;transition:background .2s;" class="mg-inline-hover">
...
<section style="background:#F5EDE4;padding:clamp(60px,9vw,110px) clamp(20px,5vw,64px);">
  <div style="max-width:860px;margin:0 auto;">
    <div style="margin-bottom:36px;">
      <p style="margin:0 0 12px;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:600;color:#04A49B;">Questions pratiques</p>
      <h2 style="margin:0;font-size:clamp(26px,4.2vw,40px);font-weight:700;letter-spacing:-.025em;color:#003850;">Avant de venir</h2>
    </div>
...
<section style="max-width:900px;margin:0 auto;padding:clamp(56px,8vw,90px) clamp(20px,5vw,24px);">
  <div style="background:#003850;border-radius:24px;padding:clamp(28px,4vw,44px);color:#fff;text-align:center;">
    <h2 style="margin:0 0 12px;font-size:clamp(24px,3.4vw,34px);font-weight:700;letter-spacing:-.025em;">On vous attend avenue Kléber</h2>
